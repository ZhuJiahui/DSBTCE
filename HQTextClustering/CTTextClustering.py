...
if __name__ == '__main__':
    ...
    read_directory1 = root_directory + u'dataset/CTLDA/doc_ct'
    read_directory2 = root_directory + u'dataset/CTLDA/ct_word'
    read_directory3 = root_directory + u'dataset/text_model/select_words'
    write_directory1 = write_directory + u'/ct_cluster_tag'
    write_directory2 = write_directory + u'/ct_real_topic'
