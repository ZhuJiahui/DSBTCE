...
if __name__ == '__main__':
    ...
    write_directory = root_directory + u'dataset/hq_text_clustering/sp_measure'
    
    read_filename1 = root_directory + u'dataset/hq_text_clustering/sp_cluster_tag/50.txt'
    ...
    spct_prf(read_filename1, read_filename2, write_filename)
