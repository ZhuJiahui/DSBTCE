...
from CTLDA.CoTrainingSP import spectral_cluster2
...
if __name__ == '__main__':
    ...
    write_directory1 = root_directory + u'dataset/CTLDA/sp_doc_ct'
    write_directory2 = root_directory + u'dataset/CTLDA/sp_ct_word'
    write_directory3 = root_directory + u'dataset/CTLDA/sp_ct_number'
    ...
    SP_CT_LDA(read_directory1, read_directory2, write_directory1, write_directory2, write_directory3)
